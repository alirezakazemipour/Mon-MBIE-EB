...
class Ask(Monitor):
    ...
    def __init__(self, env, monitor_cost=0.2, **kwargs):
        Monitor.__init__(self, env, **kwargs)
        self.action_space = spaces.Dict({"env": env.action_space, "mon": spaces.Discrete(2)})
...
class Button(Monitor, ABC):
    ...
    def __init__(self, env, monitor_cost=0.2, monitor_end_cost=2.0, **kwargs):
        ...
        # monitor on/off
        self.observation_space = spaces.Dict({"env": env.observation_space, "mon": spaces.Discrete(2)})
